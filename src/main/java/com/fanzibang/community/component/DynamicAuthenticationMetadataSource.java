...
public class DynamicAuthenticationMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    public void loadDataSource() {
        configAttributeMap = dynamicAuthenticationService.loadDataSource();
    }
